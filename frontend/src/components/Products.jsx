      ...
      <div className="products">
        <div className="wrapper">
          <div className="products__info">
            <h1 className="products__info-text">Мы делаем: </h1>
            <div className="products__info-btn">
              <div
                className={`products__info-btns btn-circle${Products.leftCircle ? " btn-active" : ""
                  }`}
                onClick={() => Products.scroll(-270)}
              >
                <svg
                  width="25"
                  height="15"
              ...
              <div
                className={`products__info-btns btn-circle${Products.rightCircle ? " btn-active" : ""
                  }`}
                onClick={() => Products.scroll(270)}
              >
                <svg
            ...
            <div className="products__info-btn-swipe">
              <img src={swipe} alt="" />
            </div>
          </div>
          <div className="products__list" ref={Products.scrollRef}>
